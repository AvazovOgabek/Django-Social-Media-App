...
class Profile(models.Model):
    ...
    liked_posts = models.ManyToManyField(Post, related_name='liked_by_profiles', blank=True)
    viewed_posts = models.ManyToManyField(Post, related_name='viewed_by_profiles', blank=True)
